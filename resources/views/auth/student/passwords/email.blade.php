                ...
                <div class="col-md-6 ml-auto mr-auto">
                    <div class="card card-signup">
                        <form class="form" method="" action="#" id="RegisterValidation">
                            <h4 class="card-title text-center mt-5">senEdu</h4>
                            <h2 class="card-title text-center ">Hesap Kurtarma</h2>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 ml-auto mr-auto mt-3">
                                        ...
                                        <div class="text-center mb-5 ">
                                            <input type="submit" value="Şifre yenile" class="btn btn-primary btn-link btn-lg mt-4">
                                        </div>
                                    </div>
                                </div>
                            </div>
