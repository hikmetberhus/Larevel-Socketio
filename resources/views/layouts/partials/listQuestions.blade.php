    ...
    @foreach($questions as $question)
        ...
        <div class="row">
            <div class="col-md-2 col-sm-2">
                <span id="question_sort"><b># {{ $question->sort  }}</b></span>
            </div>
            <div class="col-md-6 col-sm-6"></div>
            <div class="col-md-4 col-sm-4 text-right">
                <button class="btn btn-warning btn-sm" ><i class="material-icons">edit</i> DÜZENLE</button>
                <button class="btn btn-just-icon btn-danger btn-sm" ><i class="material-icons">delete</i></button>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mt-3">
                <span id="question_content">{{ $question->content }}</span>
